#!/usr/bin/env python3
"""
Plant Monitoring Data Processor - Complete IoT Integration
Consumes sensor data from Kafka, analyzes plant health, stores in MongoDB,
and integrates with Home Assistant via MQTT for IoT dashboard.
"""
