...
# MongoDB Connection String (URL-encode the password)
# Use Python to properly URL-encode special characters in the password
ENCODED_PASS=$(python3 -c "import urllib.parse; print(urllib.parse.quote('${MONGO_APP_PASS}', safe=''))")
MONGO_CONN_STRING="mongodb://${MONGO_APP_USER}:${ENCODED_PASS}@mongodb:27017/plant_monitoring?authSource=plant_monitoring"
